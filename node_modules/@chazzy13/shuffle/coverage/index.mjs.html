...
<head>
    <title>Code coverage report for index.mjs</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> index.mjs</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2x</span></td><td class="text"><pre class="prettyprint lang-js">export function shuffle(array) {
&nbsp;
...
// let myArray = [3, 6, 8, 1]
//     console.log(shuffleArray(myArray))</pre></td></tr></table></pre>
